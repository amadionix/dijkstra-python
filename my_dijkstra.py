...
class Graph:
    ...
    def dijkstra_dec(self, src):
        ...
        self.dist[src] = 0
        Q.insert(src, 0)  
        while Q.heap:                                        # estraggo una volta per nodo (a meno che non lo reincontro 
            heap_node = Q.extract_min()                      # successivamente, in quel caso forse verra' inserito e riestratto)    
            u = heap_node[0]
            self.dist[u] = heap_node[1]  
            if u not in self.adjList.keys():                 # a volte visito nodi da cui non parte nessun arco, quindi non 
                continue                                     # hanno un entry nell'adjList -> skippo otherwise keyError
            for v, w in self.adjList[u]:
...
if __name__ == "__main__":
    ...
    # # avg_d = 2,  n = 10^5, dec = 0.12, no dec = 0.46
    # path = 'Randgraph/graph_1'
    # name = "Graph 1"
    # display_experiment_results(name, path)     

    # # avg_d = 2,  n = 10^6, dec = 4.7, no dec = 8.5
    # path = 'Randgraph/graph_2'
    # name = "Graph 2"
    # display_experiment_results(name, path)

    # # avg_d = 2,  n = 10^7, dec = 23.3, no dec = 42.7, ratio = 0.546
    # path = 'Randgraph/graph_3'
    # name = "Graph 3"
    # display_experiment_results(name, path)

    # # avg_d = 3,  n = 10, dec = 0.01, no dec = 0.005
    # path = 'Randgraph/graph_4'
    # name = "Graph 4"
    # display_experiment_results(name, path)

    # # avg_d = 3,  n = 10^3, dec = 0.014, no dec = 0.010
    # path = 'Randgraph/graph_5'
    # name = "Graph 5"
    # display_experiment_results(name, path)

    # # avg_d = 3,  n = 10^5, dec = 0.22, no dec = 0.21
    # path = 'Randgraph/graph_6'
    # name = "Graph 6"
    # display_experiment_results(name, path)

    # # avg_d = 3,  n = 10^7, dec = 24.6, no dec = 43.5, ratio = 0.565
    ...
    # # avg_d = 3,  n = 3*(10^7), dec = 24.6, no dec = 43.5, ratio = 0.565
    ...
    # # avg_d = 8,  n = 10^3, dec = 12, no dec = 15
    # path = 'Randgraph/graph_8'
    # name = "Graph 8"
    # display_experiment_results(name, path)

    # # avg_d = 8,  n = 10^5, dec = 5864, no dec = 7250
    # path = 'Randgraph/graph_9'
    # name = "Graph 9"
    # display_experiment_results(name, path)  

    # # avg_d = 8,  n = 10^6, dec = 5864, no dec = 7250
    # path = 'Randgraph/graph_9b'
    # name = "Graph 9b"
    # display_experiment_results(name, path)  

    # # avg_d = 4,  n = 10^7, dec = 23.38, no dec = 42.73, ratio = 0.547
    ...
    # avg_d = 4,  n = 1.25*(10^7), dec = 23.38, no dec = 42.73, ratio = 0.547
    path = 'Randgraph/graph_10b'
    name = "Graph 10b"
    display_experiment_results(name, path)    

    # # avg_d = 5.5,  n = 2.6*(10^5), dec = 0.15, no dec = 0.69
    # path = 'Randgraph/USA-road-t.NY.gr'
    # name = "NY roads"
    # display_experiment_results(name, path)

    # # avg_d = 4.8,  n = 6.2*(10^6), dec = 15, no dec = 27
